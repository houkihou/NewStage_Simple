            ...
            <div class="clear-fix main" id="pressRelease">
                ...
                <div class="fLeft" id="contents">
                    ...
                    <div id="edit-area">
                        ...
                        <p>
                            日々の暮らしが豊かになるようなインターネットサービスを展開しており、
                            ソフトウェア開発を継続拡大してまいりました。 </p>
                        <p>
                            インターネット市場はこの20年ほどで急速な発展を続けてきましたが、今また新たな変革期を迎え、
                            その変化のスピードは今後さらに加速していくものと考えられます。<br class="u-hidden-sm">
                            <br>
                            そのような市場環境において、私たちがこれからも社会に貢献し続けていくには、
                            私たち自身が柔軟且つ迅速に変わりながら、<br class="u-hidden-sm">
                            イノベーションを起こしていくことが重要だと考えております。
                        </p>
                        <p>
                            これからも皆様のご期待にお応えできるような事業展開を行ってまいります。
                            引き続き、クーセントグループをよろしくお願い申し上げます。
                        </p>
                       
                        <p class="alignleft last mar-t30">
                            株式会社クーセント<br>
                            代表取締役社長　佐藤 直樹
                        </p>
                         <br>
